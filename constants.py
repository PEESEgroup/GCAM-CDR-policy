class GCAMConstants:
    ...
    version = [["pyrolysis", "6p0"], ["pyrolysis", "4p5"],["released", "2p6"],["released", "6p0"], ["released", "4p5"]] #TODO: updated data is grabbed for 4p5 only
    GCAMDB_filenames = ["data/gcam_out/pyrolysis/6p0/ref.csv", "data/gcam_out/pyrolysis/4p5/ref.csv", "data/gcam_out/released/2p6/ref.csv","data/gcam_out/released/6p0/ref.csv", "data/gcam_out/released/4p5/ref.csv"]
    ...
    manure_biooil_ratio["pyrolysis-nofert", "beef manure"] = 1/0.00124
    manure_biooil_ratio["pyrolysis-nofert", "dairy manure"] = 1/0.00137
    manure_biooil_ratio["pyrolysis-nofert", "pork manure"] = 1/0.00137
    manure_biooil_ratio["pyrolysis-nofert", "poultry manure"] = 1/0.00101
    manure_biooil_ratio["pyrolysis-nofert", "goat manure"] = 1/0.00137
