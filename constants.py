class GCAMConstants:
    ...
    version = [["CostHigh", "6p0"], ["CostLow", "6p0"], ["BiocharYieldHigh", "6p0"], ["BiocharYieldLow", "6p0"], ["default", "6p0"], ["released", "6p0"]]
    GCAMDB_filenames = ["data/gcam_out/CostHigh/6p0/ref.csv", "data/gcam_out/CostLow/6p0/ref.csv", "data/gcam_out/BiocharYieldHigh/6p0/ref.csv",
                        "data/gcam_out/BiocharYieldLow/6p0/ref.csv", "data/gcam_out/default/6p0/ref.csv", "data/gcam_out/released/6p0/ref.csv"]
