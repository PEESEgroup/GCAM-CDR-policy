...
### CHANGES TO A322 (Fertilizer) ###
# supplysector     subsector     technology
# N fertlizer       biochar_sup   biochar_sup

#modify A322.subsector_logit
example_file <- find_csv_file("energy/A322.subsector_logit", FALSE)[[1]]
file.copy(from = example_file, to = paste0(example_file, ".bak"))
...
print("\n file before changes")
print(tmp)
#               source 1: A322.subsector_logit
# original value (units): same assumptions as N fertilizer production from hydrogen
#     used value (units):
tmp[13] <- "N fertilizer,poultry_biochar,-12,"
tmp[14] <- "N fertilizer,pork_biochar,-12,"
tmp[15] <- "N fertilizer,beef_biochar,-12,"
tmp[16] <- "N fertilizer,dairy_biochar,-12,"
tmp[17] <- "N fertilizer,goat_biochar,-12,"
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
...
#modify A322.subsector_shrwt
example_file <- find_csv_file("energy/A322.subsector_shrwt", FALSE)[[1]]
file.copy(from = example_file, to = paste0(example_file, ".bak"))
...
print("\n file before changes")
print(tmp)
#               source 1: A322.subsector_shrwt
# original value (units): same assumptions as N fertilizer production from hydrogen
#     used value (units):
tmp[13] <- "N fertilizer,poultry_biochar,initial-future-year,,1"
tmp[14] <- "N fertilizer,pork_biochar,initial-future-year,,1"
tmp[15] <- "N fertilizer,beef_biochar,initial-future-year,,1"
tmp[16] <- "N fertilizer,dairy_biochar,initial-future-year,,1"
tmp[17] <- "N fertilizer,goat_biochar,initial-future-year,,1"
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
...
#modify A322.subsector_interp
example_file <- find_csv_file("energy/A322.subsector_interp", FALSE)[[1]]
file.copy(from = example_file, to = paste0(example_file, ".bak"))
...
print("\n file before changes")
print(tmp)
#requires matching change in A322.subsector_shrwt
#               source 1: A322.subsector_interp
# original value (units): same assumptions as N fertilizer production from hydrogen
#     used value (units): same as N fertilizer production from hydrogen
tmp[15] <- "N fertilizer,poultry_biochar,share-weight,initial-future-year,end-year,,fixed"
tmp[16] <- "N fertilizer,pork_biochar,share-weight,initial-future-year,end-year,,fixed"
tmp[17] <- "N fertilizer,beef_biochar,share-weight,initial-future-year,end-year,,fixed"
tmp[18] <- "N fertilizer,dairy_biochar,share-weight,initial-future-year,end-year,,fixed"
tmp[19] <- "N fertilizer,goat_biochar,share-weight,initial-future-year,end-year,,fixed"
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
...
#modify A322.globaltech_retirement
example_file <- find_csv_file("energy/A322.globaltech_retirement", FALSE)[[1]]
file.copy(from = example_file, to = paste0(example_file, ".bak"))
...
print("\n file before changes")
print(tmp)
#               source 1: A322.globaltech_retirement
# original value (units): same assumptions as all fertilizer technologies
#     used value (units): same assumptions as all fertilizer technologies
tmp[22] <- "N fertilizer,poultry_biochar,biochar_sup,initial-future-year,40,,20,0.3,-0.5,6"
tmp[23] <- "N fertilizer,pork_biochar,biochar_sup,initial-future-year,40,,20,0.3,-0.5,6"
tmp[24] <- "N fertilizer,beef_biochar,biochar_sup,initial-future-year,40,,20,0.3,-0.5,6"
tmp[25] <- "N fertilizer,dairy_biochar,biochar_sup,initial-future-year,40,,20,0.3,-0.5,6"
tmp[26] <- "N fertilizer,goat_biochar,biochar_sup,initial-future-year,40,,20,0.3,-0.5,6"
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
...
#modify A322.globaltech_shrwt
example_file <- find_csv_file("energy/A322.globaltech_shrwt", FALSE)[[1]]
file.copy(from = example_file, to = paste0(example_file, ".bak"))
...
# original value (units): same assumptions as fertilizer production from hydrogen
#     used value (units): same assumptions as fertilizer production from hydrogen
tmp[15] <- "N fertilizer,poultry_biochar,biochar_sup,0,0,0,0,1,1,1"
tmp[16] <- "N fertilizer,pork_biochar,biochar_sup,0,0,0,0,1,1,1"
tmp[17] <- "N fertilizer,beef_biochar,biochar_sup,0,0,0,0,1,1,1"
tmp[18] <- "N fertilizer,dairy_biochar,biochar_sup,0,0,0,0,1,1,1"
tmp[19] <- "N fertilizer,goat_biochar,biochar_sup,0,0,0,0,1,1,1"
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
...
#modify A322.globaltech_coef
example_file <- find_csv_file("energy/A322.globaltech_coef", FALSE)[[1]]
file.copy(from = example_file, to = paste0(example_file, ".bak"))
...
print("\n file before changes")
print(tmp)
#               source 1: A21.sector, Baniasadi, M. et al. Waste to energy valorization of poultry litter by slow pyrolysis. Renewable Energy 90, 458–468 (2016).
#               source 2: Atienza-Martínez, M., Ábrego, J., Gea, G. & Marías, F. Pyrolysis of dairy cattle manure: evolution of char characteristics. Journal of Analytical and Applied Pyrolysis 145, 104724 (2020).
#               source 3: Enders, A., Hanley, K., Whitman, T., Joseph, S. & Lehmann, J. Characterization of biochars to evaluate recalcitrance and agronomic performance. Bioresource Technology 114, 644–653 (2012).
#               source 4: Poddar, S. & Sarat Chandra Babu, J. Modelling and optimization of a pyrolysis plant using swine and goat manure as feedstock. Renewable Energy 175, 253–269 (2021).
# original value (units): GJ/kg N (input/output coefficient)
#     used value (units): 0.077 Mt biochar / Mt N (N content for biochar at 500 C)
# note that these units are different from those for the other variables, which is because the input is in Mt biochar, not GJ energy
tmp[15] <- "N fertilizer,poultry_biochar,biochar_sup,poultry_biochar,12.98,12.98,12.98,12.98" # [1] 7.7%
tmp[16] <- "N fertilizer,pork_biochar,biochar_sup,pork_biochar,44.05,44.05,44.05,44.05" # [4] 2.27%
tmp[17] <- "N fertilizer,beef_biochar,biochar_sup,beef_biochar,90.9,90.9,90.9,90.9" # [3] 1.1%
tmp[18] <- "N fertilizer,dairy_biochar,biochar_sup,dairy_biochar,54.34,54.34,54.34,54.34" # [2] 1.84%
tmp[19] <- "N fertilizer,goat_biochar,biochar_sup,goat_biochar,51.54,51.54,51.54,51.54" # [4]
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
...
tmp[284] <- "N fertilizer,poultry_biochar,biochar_sup,,,,,,"
tmp[285] <- "N fertilizer,pork_biochar,biochar_sup,,,,,,"
tmp[286] <- "N fertilizer,beef_biochar,biochar_sup,,,,,,"
tmp[287] <- "N fertilizer,dairy_biochar,biochar_sup,,,,,,"
tmp[288] <- "N fertilizer,goat_biochar,biochar_sup,,,,,,"
...
tmp[281] <- "N fertilizer,poultry_biochar,biochar_sup,,,,,,"
tmp[282] <- "N fertilizer,pork_biochar,biochar_sup,,,,,,"
tmp[283] <- "N fertilizer,beef_biochar,biochar_sup,,,,,,"
tmp[284] <- "N fertilizer,dairy_biochar,biochar_sup,,,,,,"
tmp[285] <- "N fertilizer,goat_biochar,biochar_sup,,,,,,"
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
...
tmp[189] <- "N fertilizer,poultry_biochar,biochar_sup,,,,,,"
tmp[190] <- "N fertilizer,pork_biochar,biochar_sup,,,,,,"
tmp[191] <- "N fertilizer,beef_biochar,biochar_sup,,,,,,"
tmp[192] <- "N fertilizer,dairy_biochar,biochar_sup,,,,,,"
tmp[193] <- "N fertilizer,goat_biochar,biochar_sup,,,,,,"
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
