...
tmp[15] <- "biochar,slow pyrolysis,poultry_biochar,non-energy,0.0101,0.0101"
tmp[16] <- "biochar,slow pyrolysis,pork_biochar,non-energy,0.0101,0.0101"
tmp[17] <- "biochar,slow pyrolysis,beef_biochar,non-energy,0.0103,0.0103"
tmp[18] <- "biochar,slow pyrolysis,dairy_biochar,non-energy,0.0100,0.0100"
tmp[19] <- "biochar,slow pyrolysis,goat_biochar,non-energy,0.0097,0.0097"
print("\n file after changes")
print(tmp)
