...
tmp[15] <- "biochar,slow pyrolysis,poultry_biochar,non-energy,0.0331,0.0331"
tmp[16] <- "biochar,slow pyrolysis,pork_biochar,non-energy,0.0332,0.0332"
tmp[17] <- "biochar,slow pyrolysis,beef_biochar,non-energy,0.0339,0.0339"
tmp[18] <- "biochar,slow pyrolysis,dairy_biochar,non-energy,0.0328,0.0328"
tmp[19] <- "biochar,slow pyrolysis,goat_biochar,non-energy,0.0320,0.0320"
print("\n file after changes")
print(tmp)
