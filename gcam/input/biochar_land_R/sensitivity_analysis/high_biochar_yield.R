...
tmp[16] <- "biochar,slow pyrolysis,poultry_biochar,poultry manure,1.877,1.877,1.877" #[1]
tmp[17] <- "biochar,slow pyrolysis,pork_biochar,pork manure,1.898,1.898,1.898" # [4]
tmp[18] <- "biochar,slow pyrolysis,beef_biochar,beef manure,1.992,1.992,1.992" #[3]
tmp[19] <- "biochar,slow pyrolysis,dairy_biochar,dairy manure,1.992,1.992,1.992" #[2]
tmp[20] <- "biochar,slow pyrolysis,goat_biochar,goat manure,1.782,1.782,1.782" #[4]
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
