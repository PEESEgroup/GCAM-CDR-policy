...
tmp[16] <- "biochar,slow pyrolysis,poultry_biochar,poultry manure,2.666,2.666,2.666" #[1]
tmp[17] <- "biochar,slow pyrolysis,pork_biochar,pork manure,2.328,2.328,2.328" # [4]
tmp[18] <- "biochar,slow pyrolysis,beef_biochar,beef manure,2.232,2.232,2.232" #[3]
tmp[19] <- "biochar,slow pyrolysis,dairy_biochar,dairy manure,2.232,2.232,2.232" #[2]
tmp[20] <- "biochar,slow pyrolysis,goat_biochar,goat manure,2.434,2.434,2.434" #[4]
print("\n file after changes")
print(tmp)
readr::write_lines(tmp, example_file)
